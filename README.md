...
## Latest Release
The latest version of the module is v1.4.8 (_under development_). Refer the [CHANGE LOG](https://github.com/kartik-v/yii2-dynagrid/blob/master/CHANGE.md) for details.
